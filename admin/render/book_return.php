<?php
    ...
    {
        $sql = "INSERT INTO booktransaction (id, libraryid, name, courseSection, email, bookAccessNo, bookTitle, bookAuthor, pickupDate, returnDate, fine, remarks) 
                VALUES ('$id', '$libraryId', '$name', '$course', '$email', '$accessNo', '$title', '$author', '$pickupDate', '$returnDate', '$fine', 'Returned')";
        ...
        <div class="container text-center pt-5">
            ...
            <div class="col-sm-10 col-lg-6 text-start border border-secondary rounded ps-5 ms-auto me-auto">
                ...
                <?php
                    ...
                    echo '<p><strong>Fine:</strong> ' . $fine . '</p>';
                ?>
                <!-- Button to insert data into bookborrowed table -->
                <form method="post" class="text-end">
                    <button type="submit" class="btn btn-success m-3" name="insert_button">RETURN</button>
                </form>
